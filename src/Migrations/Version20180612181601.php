 ...
 */
final class Version20180612181601 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, question VARCHAR(255) NOT NULL, reponse VARCHAR(255) NOT NULL, prop1 VARCHAR(255) DEFAULT NULL, prop2 VARCHAR(255) DEFAULT NULL, prop3 VARCHAR(255) DEFAULT NULL, prop4 VARCHAR(255) DEFAULT NULL, INDEX IDX_A412FA9259027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
